...
import ru.rumigor.cookbook.data.stomp.stomp.provider.OkHttpConnectionProvider;
import ru.rumigor.cookbook.data.stomp.stomp.provider.WebSocketsConnectionProvider;
...
public class Stomp {
    ...
    private static StompClient createStompClient(ru.rumigor.cookbook.data.stomp.stomp.provider.ConnectionProvider connectionProvider) {
